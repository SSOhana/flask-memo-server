...
class UserRegisterResource(Resource) :
    ...
    def post(self) :
        ...
        except EmailNotValidError as e :       # 이메일 형식이 이상하면 이쪽으로 넘어온다.
            return { "error" : str(e), "error_no" : 1 }, 400


        # 3. 비밀번호 길이 체크 (4자리 이상 12자리 이하가 정상!)
        ...
        # 5. JWT 억세스 토큰을 생성해서 클라이언트에 응답해준다.
